...
To support this system, we need to develop comprehensive algorithms that can calculate rewards and progress behind the scenes. To ensure these algorithms are effective and accurate, we created a simulator that helps visualize and clarify the reward system before actual development begins.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, , height=10cm]{src/assets/images/simulator.png}
